...
Puedes [mensajes de etiqueta](../publish/#tags-emojis) con emojis y otras 🥳 🎉 cadenas relevantes. Las etiquetas coincidentes se realizan automáticamente
convertido a emojis. Esta es una referencia de todos los emojis compatibles. Para obtener más información sobre la función, consulte el
[página de etiquetado y emojis](../publish/#tags-emojis).
