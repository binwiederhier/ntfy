...
| `percentage`  | -        | *number*                                                                        | `45`                                                  | Progress value (`0` to `100`) when [updating notifications](../publish.md#updating-notifications)                               |
| `end`         | -        | *number*                                                                        | `1717020000`                                          | Unix timestamp for countdown when [updating notifications](../publish.md#updating-notifications)                                |
