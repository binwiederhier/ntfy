...
var (
	...
	errHTTPInternalErrorMissingBaseURL               = &errHTTP{50003, http.StatusInternalServerError, "internal server error: base-url must be configured for this feature", "https://ntfy.sh/docs/config/", nil}
