...
## Requirements
!!! note 
    These requirements are strictly based off of my development on this app. There may be other versions of macOS / XCode that work. Feel free to test on other versions!
...
!!! info
    Along with this step, the "Setup - PLIST Deployment and Configuration" step is also required for these changes to take effect in the iOS app.
