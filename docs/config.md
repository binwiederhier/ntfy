...
* `smtp-server-max-multipart-depth` is how deeply nested a multipart MIME message may be before it is rejected
  as "nested too deep" (default: `2`). Ordinary mail is generally covered by the default but some senders my
  nest things deeper and require a higher value.
...
| `smtp-server-max-multipart-depth`          | `NTFY_SMTP_SERVER_MAX_MULTIPART_DEPTH`          | *int*                                               | 2                 | Maximum nesting depth of multipart MIME parts in incoming e-mail                                                                                                                                                                        |
...
OPTIONS:
   ...
   --smtp-server-max-multipart-depth value, --smtp_server_max_multipart_depth value                                       maximum nesting depth of multipart MIME parts in incoming e-mail (default: 2) [$NTFY_SMTP_SERVER_MAX_MULTIPART_DEPTH]
