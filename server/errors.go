...
var (
	...
	errHTTPTooManyIdenticalMessagesInShortTime       = &errHTTP{42911, http.StatusTooManyRequests, "limit reached: too many identical messages in short time", "https://ntfy.sh/docs/publish/#limitations", nil}
